...
public class ResourceServerDefaultPermissionCreator {
    ...
    private PolicyRepresentation createDefaultPolicy() {
        ...
        // validate existing:
        Policy existing = policyStore.findByName(resourceServer, defaultPolicy.getName());
        ...
        // persist:
        policyStore.create(resourceServer, defaultPolicy);
    ...
    private ResourceRepresentation createDefaultResource(ClientModel client) {
        ...
        Resource existingResource = storeFactory.getResourceStore().findByName(resourceServer, defaultResource.getName(), ownerId);
    ...
    private void createDefaultPermission(ResourceRepresentation resource, PolicyRepresentation policy) {
        ...
        // validate already existing:
        Policy existing = policyStore.findByName(resourceServer, defaultPermission.getName());
        ...
        // persist:
        policyStore.create(resourceServer, defaultPermission);
    }
}