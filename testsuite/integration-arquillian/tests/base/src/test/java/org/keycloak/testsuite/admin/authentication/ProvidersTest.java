...
public class ProvidersTest extends AbstractAuthenticationTest {
    ...
    private List<Map<String, Object>> expectedAuthProviders() {
        ...
        addProviderInfo(result, "idp-auto-link-restrictive", "Automatically set existing user using custom restrictions", "Automatically set existing user to authentication context if existing user password is not set or existing user has verified email");
