...
@NamedQueries({
        ...
        @NamedQuery(name="getClientsByAttributeName", query="select client.id from ClientEntity client join client.attributes attr where client.realmId = :realm and attr.name = :name and attr.value = :value"),
